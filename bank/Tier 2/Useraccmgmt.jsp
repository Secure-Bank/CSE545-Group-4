...
<div class="content">
  ...
  <div id="login-box-ext-usr">
	<ol id="toc">
	  <li><a href="custaccount.jsp"><span>Account</span></a></li>
      ...
      <li><a href="EmpProfile.jsp"><span>Profile</span></a></li>
      <li   class="current"><a href="Useraccmgmt.jsp"><span>Account Management</span></a></li>   
	...
	<form:form  method="post" commandName="form" >
		...
		<tr>
			...
			<td>
				<input type="radio" id="modifyacc" name="modify" value="create"/>Modify an user account
			</td>
			<td>
				<input type="radio" id="viewacc" name="modify" value="create"/>View an user account
			</td>
			<td>
				<input type="radio" id="deleteacc" name="modify" value="delete"/>Select an account to Close				
			</td>
		</tr>
...
<!-- 		<tr>
		...
		<input type="submit" id="modifybtn" value="Submit Request"><br><br>
	</form:form>
	</div>
   </div>
</div>
